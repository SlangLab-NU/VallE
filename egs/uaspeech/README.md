...
```
python3 bin/infer.py --output-dir infer/demos     --checkpoint=${exp_dir}/best-valid-loss.pt   --text-prompts ""  --audio-prompts "" --text atyp_to_atyp_inference_list.txt --textless False
```
